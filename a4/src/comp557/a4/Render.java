...
public class Render extends WindowAdapter {
    ...
    /** Flag to indicate when to use jitter */
    public boolean jitter;
    
    /** Flag to indicate when to use depthOfField */
    public boolean depthOfField;

    
    /** Number of threads to be used when drawing must be set to power of 2 (for easier division) default of 1*/
